...
public class Consts {
    ...
    // Q-municate release
    public static final String QB_APP_ID = "28021";
    public static final String QB_AUTH_KEY = "TWGB2jnHfV8CJaQ";
    public static final String QB_AUTH_SECRET = "yDALLbFxpVMZhLN";
